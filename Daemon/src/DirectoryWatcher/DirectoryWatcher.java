                        ...
                        // case file creation
                            ...
                            if (!Pattern.matches(".*\\.danload",fileName )) {
                                try {
                                    ...
                                    Integer socketPort = Integer.parseInt(System.getenv("TCP_PORT"));
                                    daemon.notifyFileCreation(fileName, Files.size(filePath), socketPort); // Notify Daemon of file creation
                                } catch (IOException e) {
